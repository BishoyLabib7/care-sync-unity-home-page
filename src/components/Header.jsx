  ...
  return (
    <header className="sm:px-16 md:px-24 lg:px-36 shadow-md bg-[#0B3E7A] text-white flex justify-between items-center p-2 w-full sticky top-0 z-50 h-[91px]">
      <div className="md:hidden">
        ...
        {/* Overlay */}
        <div
          className={`fixed bg-black bg-opacity-60 top-0 left-0 w-screen h-screen ${
        ...
        <div
          ...
          } w-60 transition-all fixed top-0 left-0 p-5 shadow-lg h-full bg-[#0B3E7A] flex flex-col rounded-r-lg z-10`}>
          <div className="border-b pb-5">
            <img
              alt="Kliniki Logo"
              loading="lazy"
